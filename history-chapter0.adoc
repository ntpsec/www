= Chapter 0: How NTPsec came to be (2013-2017) =

link:history.html[Contents] | link:history-chapter1.html[Next: After first ship]
...
link:history-chapter1.html[Chapter 1: After first ship].
